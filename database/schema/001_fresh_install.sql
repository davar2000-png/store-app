-- =========================================================
-- ⚠️ هشدار امنیتی مهم — این فایل فقط برای نصب روی یک
-- دیتابیس کاملاً جدید و خالی است.
--
-- این اسکریپت با دستور DROP TABLE هر جدولی با همین نام را
-- که از قبل وجود داشته باشد کاملاً حذف می‌کند (همراه با تمام
-- داده‌های داخلش).
--
-- 🔴 هرگز این فایل را روی دیتابیس Production که داده واقعی
-- دارد اجرا نکنید. برای آپدیت یک دیتابیس موجود، از پوشه
-- database/migrations/ استفاده کنید (که غیرمخرب است).
-- =========================================================
